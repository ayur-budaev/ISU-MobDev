...
fun create_json(CSVfile: String, JSONfile: String){
    val gson = Gson()
    val gsonPretty = GsonBuilder().setPrettyPrinting().create()

    var data : MutableMap<String, Appl> = mutableMapOf()

    var fileCSV = File(CSVfile)
    var fileExists = fileCSV.exists()

    var API_ver : Map<String, String> = mapOf("1.0" to "1","1.1" to "2","1.5" to "3","1.6" to "4",
                                              "2.0" to "5","2.0.1" to "6","2.1" to "7","2.2" to "8",
                                              "2.3" to "9","2.3.3" to "10","3.0" to "11","3.1" to "12",
                                              "3.2" to "13","4.0" to "14","4.0.3" to "15","4.1" to "16",
                                              "4.2" to "17","4.3" to "18","4.4" to "19","4.4W" to "20",
                                              "5.0" to "21","5.1" to "22","6.0" to "23","7.0" to "24",
                                              "7.1" to "25","8.0" to "26","8.1" to "27","9.0" to "28",
                                              "10.0" to "29","11.0" to "30", "Varies" to "Unknown", "NaN" to "Unknown")

    var monthes : Map<String, String> = mapOf("January" to "1","February" to "2","March" to "3",
    ...
    if(fileExists){
        val rowss: List<Map<String, String>> = csvReader().readAllWithHeader(CSVfile)
        ...
        File(JSONfile).writeText(gsonPretty.toJson(data))
